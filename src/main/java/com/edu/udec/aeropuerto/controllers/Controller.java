...
public class Controller {
    ...
    public Controller() {
        ...
        get("/api/sensor/:id/regresion", (req, res) -> {
            ...
            List<Dato> historial = byId.get().getHistorial();
/*            FastVector atts = new FastVector();
            Attribute fechaCreacion = new Attribute("FechaCreacion");
            atts.addElement(fechaCreacion);
            atts.addElement(new Attribute("Decibeles"));
            ...
            historial.forEach(e -> {
                ...
                instance.setValue((Attribute) atts.elementAt(0), historial.indexOf(e));
                instance.setValue((Attribute) atts.elementAt(1), e.getDecibeles());
